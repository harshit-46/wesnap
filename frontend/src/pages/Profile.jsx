...
export default function ProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-[#edf2fb] dark:bg-[#0A0A0A] text-zinc-900 dark:text-white">
            <Navbar />

            <main className="md:ml-64 px-4 py-8">
                <div className="max-w-3xl mx-auto">
                    <section className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden mb-6">
                        <div className="h-48 bg-linear-to-br from-zinc-300 to-zinc-200 dark:from-zinc-800 dark:to-zinc-700" />

                        <div className="px-6 pb-6 relative">
                            <div className="flex justify-between items-start -mt-16 mb-4">
                                <div className="w-32 h-32 rounded-full border-4 border-white dark:border-zinc-900 bg-linear-to-br from-blue-500 to-blue-600 flex items-center justify-center text-4xl font-bold text-white shadow-xl">
                                    {(profileUser.name || profileUser.username).charAt(0)}
                                </div>

                                {isOwnProfile ? (
                                    <button className="mt-4 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 px-6 py-2 rounded-lg text-sm">
                                        Edit Profile
                                    </button>
                                ) : (
                                    <button
                            ...
                            {!isOwnProfile && (
                                <button
                                    ...
                                    className="mb-4 bg-zinc-200 dark:bg-zinc-800 hover:bg-zinc-300 dark:hover:bg-zinc-700 px-4 py-2 rounded-lg text-sm"
                                >
                                    Message
                                </button>
                            )}

                            <div className="flex gap-6 border-t border-zinc-200 dark:border-zinc-800 pt-4 text-sm">
                                <div>
                    ...
                    <div className="border-b border-zinc-200 dark:border-zinc-800 mb-6 flex gap-8">
...
export default function ProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-[#F9FAFB] dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100">
            ...
            <main className="md:ml-64 px-4 py-10">
                <div className="max-w-3xl mx-auto">
                    {/* Profile Card */}
                    <section className="
