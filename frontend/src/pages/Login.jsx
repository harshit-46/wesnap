        ...
        >
            <div className="w-full max-w-md">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-black"
                                required
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-12 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-black"
                                required
                            />
                            <button
                                type="button"
                ...
                <button
                    ...
                    className={`mt-4 w-full py-3 px-4 bg-white border border-gray-200 rounded-lg font-medium transition flex items-center justify-center gap-3 cursor-pointer ${isLoading ? "opacity-60 cursor-not-allowed" : "hover:bg-gray-50"}`}>
